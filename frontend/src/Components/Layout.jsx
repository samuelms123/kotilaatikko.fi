      ...
      <header className="border-b-2 border-[var(--primary-color)]">
        ...
        <footer className="bg-[var(--grey-color)] pb-12 text-[var(--white-color)]">
          <div className="max-w-[1600px] mx-auto text-center">
            ...
            <div className="pt-15">
              <p className="text-[90%]">
                &#169; kotilaatikko.fi 2025 &#8212; Helposti ruokaa
                kotiovellesi!{' '}
              </p>
              <div className="flex justify-center pt-5">
                <a href="http://tiktok.com">
                  <img
                    ...
                    src={`${import.meta.env.BASE_URL}tt-icon.png`}
                ...
                <a href="http://facebook.com">
                  <img
                    className="w-auto h-8 mr-2"
                    src={`${import.meta.env.BASE_URL}fb-icon.png`}
                ...
                <a href="http://instagram.com">
                  <img
                    className="w-auto h-8 mr-2"
                    src={`${import.meta.env.BASE_URL}ig-icon.png`}
