...
const NotFound = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-white text-center px-4 mt-15">
      {/* Animated 404 Text */}
      ...
      <h2 className="text-2xl text-[var(--primary-color)] sm:text-3xl font-[header] mb-4">
        Oho! Sivua ei löytynyt. :&#40;
      </h2>
      <p className="text-lg sm:text-xl text-black mb-20">
        Näyttää siltä, että etsimääsi linkkiä ei ole olemassa. Mutta ei hätää, voit palata etusivulle!
      </p>
